...
public class MegazineComponent extends javax.swing.JPanel {
    ...
    private void fillView() {
        ...
        Revista megazine = new Revista(txtIdentificationCode.getText());
        Revista megazineSelected = megazine.SeleccionarRevista(con);
        if (megazineSelected == null) {
        ...
        txtTitulo.setText(megazineSelected.getTitulo());
        txtUnidadesDisponibles.setText(String.valueOf(megazineSelected.getUnidadesDisponibles()));
        txtPeriodicidad.setText(megazineSelected.getPeriodicidad());
        txtFechaPublicidad.setText(megazineSelected.getFechaPublicacion());
        cmbEditorial.setSelectedItem(megazineSelected.getEditorial());
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        ...
        try {
            Revista megazine = new Revista(IdentificationCode, txtTitulo.getText(), availableUnits, cmbEditorial.getSelectedItem().toString(), 1, txtPeriodicidad.getText(), txtFechaPublicidad.getText());
            megazine.updateRevista(con, editorialMap.get(cmbEditorial.getSelectedItem().toString()));
